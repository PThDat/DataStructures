...
template <class T>
void SinglyLinkedList<T>::AddHead(const T& newData)
{
    if (Head == NULL)
    {
...
template <class T>
void SinglyLinkedList<T>::AddTail(const T& newData)
{
    if (Head == NULL)
    {
        Head = Tail = new Node<T>(newData);
...
template <class T>
Node<T>* SinglyLinkedList<T>::ElementAt(int index)
{
...
template <class T>
void SinglyLinkedList<T>::SwapElement(int index1, int index2)
{
...
template <class T>
void SinglyLinkedList<T>::InsertAt(int index, const T& newData)
{
    if (index <= 0)
    {
        AddHead(newData);
